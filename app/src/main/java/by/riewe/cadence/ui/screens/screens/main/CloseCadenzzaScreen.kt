        ...
        LazyColumn(
            ...
            item {
                OutlinedTextField(
                    ...
                    leadingIcon = { Icon(
                        painter = painterResource(R.drawable.trailer), contentDescription = null) },
                    modifier = Modifier
                        .fillMaxWidth()
                        .shadow(
                            elevation = 4.dp,
                ...
                Button(
                    onClick = {
                        ...
                        if (endOdometer <= startOdometer) {
                            emptyFields.add("Одометр в конце должен быть больше начального ($startOdometer)")
                        }
                        val startDate: Long = startCadenzza?.startDate ?: 0L
                        if (endDate.toLong() < startDate) {
                            emptyFields.add("Дата окончания не может быть раньше даты начала")
                        }
